...
-export([get_config_value/2, logging/2, logstop/0,
  pushSL/2, popSL/1, popfiSL/1, findSL/2, findneSL/2, lengthSL/1, minNrSL/1, maxNrSL/1, getEmptySL/0, emptySL/1, delete_last/1, shuffle/1,
...
%% -------------------------------------------
% Sortierte Liste. Kleinstes Element steht rechts (hinten), groesstes links (vorn)
%
